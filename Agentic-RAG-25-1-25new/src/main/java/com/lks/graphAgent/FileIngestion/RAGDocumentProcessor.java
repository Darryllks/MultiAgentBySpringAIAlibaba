package com.lks.graphAgent.FileIngestion;
...
public class RAGDocumentProcessor {
    ...
    // 使用新的语义感知文本分割器，结合递归分割和语义相似性聚类
    private final SemanticAwareTextSplitter textSplitter;

    public RAGDocumentProcessor(VectorStore vectorStore, EmbeddingModel embeddingModel) {
        this.vectorStore = vectorStore;
        this.parser = new TikaDocumentParser();
        this.textSplitter = new SemanticAwareTextSplitter(500, 100,
                new String[]{"\n\n", "\n", "。", "！", "？", "；", "，", " "}, 0.6, 4, embeddingModel);
    }
